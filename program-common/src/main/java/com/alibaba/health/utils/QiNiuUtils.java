...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "l5Qpw7ipm_7cOC6A4WFHEMUXBa9Es_yvO19wW8PX";
    private static final String SECRETKEY = "vPsX8YTpIurM_QhHeWQwdjoVA0VZN3On3VvOgoah";
    private static final String BUCKET = "th1019";
    public static final String DOMAIN = "http://qmpp67gfs.hn-bkt.clouddn.com/";
    private static long logTimestemp4Toke = 0l;
    private static String token = null;

    public static void main(String[] args) {
        uploadFile("C:\\Users\\Lenovo\\Desktop\\timg2.jpg","timg2.jpg");
